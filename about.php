                    ...
                    <div class="col-xl-6">
                        <div class="about-seven__right">
                            ...
                            <div class="about-seven__btn-box">
                                <a href="about.php" class="thm-btn about-seven__btn">discover More</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">                                
                                <div class="accrodion active">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Yes, we provide tailor-made refrigeration solutions designed to meet the unique requirements of industries like frozen food, dairy, and beverages.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>We have a nationwide network and deliver our products and services across India.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Yes, we offer dedicated after-sales support to assist with troubleshooting, maintenance, and customer queries.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <h4>What industries benefit from your products?</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Our products cater to industries such as frozen food, dairy, beverages, hospitality, and more.</p>
                                        </div><!-- /.inner -->
                                    </div>
                                </div>
                            </div>
